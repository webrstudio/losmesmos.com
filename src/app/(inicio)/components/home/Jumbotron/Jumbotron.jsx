  ...
  return (
    <section className={styles.jumbotronWrapper}>
      ...
      <div className={styles.jumbotronTitles}>
        ...
        <h1>¡Los payasos <span className={styles.markupLetter}>más virales</span> de México!</h1>
        <a href='https://www.youtube.com/@losmesmosshow' target='_blank' className={styles.jumbotronButton}>
